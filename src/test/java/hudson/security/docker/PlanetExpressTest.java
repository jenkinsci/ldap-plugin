...
public class PlanetExpressTest {
    ...
    public void login() throws Exception {
        LDAPSecurityRealm realm = new LDAPSecurityRealm(container.getHost() + ":" + container.getFirstMappedPort(), DN, null, null, null, null, null, MANAGER_DN, Secret.fromString(MANAGER_SECRET), false, false, null, null, "cn", "mail", null,null);
